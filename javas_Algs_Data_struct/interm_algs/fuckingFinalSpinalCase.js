...
function spinalCase(str){
	...
	return str.split("").map(function(el, idx){
		...
		if(idx == 0){
			return el.toLowerCase() //Had to have this since I assumed that first char was to be uppercase;
			//Just happy to submit and go on 
...
for (let myTest in input){
	console.log(spinalCase(input[myTest]))
}
